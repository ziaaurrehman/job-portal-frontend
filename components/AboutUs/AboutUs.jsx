      ...
      <div>
        ...
        <div className="md:mt-20 mt-10 md:py-12 py-6 h-auto w-full md:px-16 p-3 rounded-[10px] border-[#5E3D6E] border-[5px]">
          ...
          <p className=" capitalize md:text-left line text-center md:py-5 lg:text-4xl md:text-xl text-base font-medium">
            Welcome to CorpConnect, Azerbaijan's corporate recruitment hub. Our
            ...
            ambition, and where every successful placement of Azerbaijan's
        ...
        <div className="md:mt-20 mt-10 md:py-12 py-6 h-auto w-full md:px-16 p-3 rounded-[10px] border-[#5E3D6E] border-[5px]">
          ...
          <p className=" capitalize md:text-left line text-center md:py-5 lg:text-4xl md:text-xl text-base font-medium">
            At CorpConnect, we've embarked on a mission that goes beyond the
            simple. We're not just about connecting job seekers with employers;
            ...
            personal development, but also to the country's global aspirations.
