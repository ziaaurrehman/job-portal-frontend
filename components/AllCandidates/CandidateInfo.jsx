  ...
  return (
    <div className="lg:w-[501px] w-full rounded-[5px] border-[#5E3D6E] border-[3px]">
      ...
      <div className="flex md:flex-row flex-col w-full px-5 md:space-x-4 md:space-y-0 space-y-3 py-5">
        <button className="lg:w-[173px] px-3 lg:px-0 h-[45px] flex border border-[#3E1652] justify-center items-center shadow-xl rounded-[5px] bg-[#6F2691]">
          <div className="lg:h-[27px] lg:w-[27px] md:h-[25px] md:w-[25px] h-[15px] w-[15px]">
            <Image
              height={0}
              width={0}
              sizes="100vw"
        ...
        <button className="lg:w-[123px] px-3 lg:px-0 h-[45px] flex border border-[#3E1652] justify-center items-center shadow-xl rounded-[5px]">
          ...
          <p className="text-[15px] font-normal">Message</p>
        </button>
        <button className="lg:w-[89x] px-3 lg:px-3 h-[45px] flex border border-[#3E1652] justify-center items-center shadow-xl rounded-[5px]">
          <div className="lg:h-[27px] lg:w-[27px] md:h-[25px] md:w-[25px] h-[15px] w-[15px]">
            <Image
              height={0}
              width={0}
          ...
          <p className="text-[15px] font-normal">Call</p>
        </button>
      </div>
