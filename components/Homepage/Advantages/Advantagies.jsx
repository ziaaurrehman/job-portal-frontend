            ...
            <ul className="flex md:mt-10 mt-5 flex-col xl:w-[38%] lg:w-1/2 w-full space-y-5 items-center justify-center">
              ...
              <li className="w-full">
                <Link href="/page/search-job">
                  <button className="w-[184px] md:h-[70px] h-[50px] hover:border hover:border-[#6F2691] hover:text-[#6F2691] hover:bg-transparent bg-[#6F2691] md:mt-8 mt-5 rounded-[5px] text-white md:text-xl text-lg font-semibold">
                    Search a Job
                  </button>
                </Link>
              </li>
            ...
            <ul className="flex md:mt-10 mt-5 flex-col xl:w-[38%] lg:w-1/2 w-full space-y-5 items-center justify-center">
              ...
              <li className="w-full">
                <Link href="/page/post-job">
                  <button className="w-[184px] hover:border hover:border-[#6F2691] hover:text-[#6F2691] hover:bg-transparent md:h-[70px] h-[50px] bg-[#6F2691] md:mt-8 mt-5 rounded-[5px] text-white md:text-xl text-lg font-semibold">
                    Post a Job
                  </button>
                </Link>
              </li>
