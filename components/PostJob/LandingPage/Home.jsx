                    ...
                    <div className="w-full flex justify-end items-center mt-14">
                      <Link href="/page/add-job-basic">
                        <button
                          ...
                          className="md:text-[22px] flex justify-center items-center space-x-3 text-lg font-bold border text-white border-[#45155D] px-[30px] bg-[#6F2691] md:w-[254px] w-[150px] md:h-[70px] h-12 md:mt-3 rounded-[10px]"
                        >
                          <p>Continue</p>
                          <div>
                            <Image
